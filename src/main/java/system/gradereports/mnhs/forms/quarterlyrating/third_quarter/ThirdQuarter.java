...
public class ThirdQuarter {
    ...
    public ThirdQuarter(ThirdQuarter firstQuarter, Subject subject, Long grade, Student student) {
    ...
    public ThirdQuarter(Subject subject, Long grade, Student student) {
        this.subject = subject;
        this.grade = grade;
        this.student = student;
    }
